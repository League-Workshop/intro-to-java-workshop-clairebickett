...
public class DragonFight {
	...
	int playerHealth = 100; 
		...
		// 8. Ask the player in a pop-up if they want to attack the dragon with a yell or a kick
			String kick = JOptionPane.showInputDialog(null, "Do you want to attack with a yell or a kick?");
		...
		if (playerHealth <= 0) {
			...
			JOptionPane.showMessageDialog(null, "You lost and were eaten!"); }
		
		// 14. Else if the dragon's health is less than or equal to 0
		else if (dragonHealth <= 0) { 
				JOptionPane.showMessageDialog(null, "You won the dragon is dead! And you took a ton of gold! Yay!");
			}
